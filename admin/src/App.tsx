...
export default function App() {
  ...
  // Fetch Verification Frames from shared backend API
  const fetchFrames = useCallback(async () => {
    ...
    try {
      ...
      console.error("[Admin App] Error fetching verification frames:", err);
    }
  ...
  const handleDecision = async (statusDecision: "approved" | "rejected" | "corrected") => {
    ...
    try {
      ...
      console.error("[Admin App] Error updating annotation decision:", err);
    }
  };
  ...
  const handleIngest = async () => {
    ...
    try {
      ...
      console.error("[Admin App] Ingestion failed:", err);
    } finally {
      ...
      <header className={styles.header}>
        <div className={styles.brand}>
          ...
          <div>
            ...
            <div className={styles.subtitle}>AUTHENTICATED HITL ADMIN DASHBOARD APP</div>
          </div>
        </div>
